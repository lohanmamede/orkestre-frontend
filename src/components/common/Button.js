...
const Button = ({ 
  ...
  const variants = {
    ...
    accent: "bg-accent-600 hover:bg-accent-700 text-white focus:ring-accent-500 shadow-soft hover:shadow-medium",
    success: "bg-success-600 hover:bg-success-700 text-white focus:ring-success-500 shadow-soft hover:shadow-medium",
    warning: "bg-warning-600 hover:bg-warning-700 text-white focus:ring-warning-500 shadow-soft hover:shadow-medium",
    error: "bg-error-600 hover:bg-error-700 text-white focus:ring-error-500 shadow-soft hover:shadow-medium",
