    ...
    <div className={`rounded-lg border p-4 ${currentType.bg} ${currentType.border} ${className}`}>
      <div className="flex">
        <div className="flex-shrink-0">
          <span className={currentType.text}>
          ...
          <div className="ml-auto pl-3">
            <div className="-mx-1.5 -my-1.5">
              <button
                type="button"
                onClick={onClose}
                className={`inline-flex rounded-md p-1.5 ${currentType.text} hover:opacity-75 focus:outline-none focus:ring-2 focus:ring-offset-2`}
              >
